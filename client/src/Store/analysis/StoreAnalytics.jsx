    ...
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-purple-50 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-purple-800 mb-2">Products Sold</h3>
          <p className="text-3xl font-bold text-purple-600">{analytics.productsSold || 0}</p>
        </div>
      </div>
      
      <div className="bg-white rounded-lg shadow p-6">
        <h3 className="text-xl font-semibold mb-4">Recent Activity</h3>
        <p className="text-gray-500">Analytics details would be displayed here based on your backend implementation</p>
      </div>
    </div>
  );
}
