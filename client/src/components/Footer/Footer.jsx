...
import { Gamepad2, Twitter, Facebook, Instagram, Twitch, Youtube, Heart } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              Your ultimate destination for gaming news, reviews, and community. Join thousands of gamers in our vibrant community.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-purple-400 transition-colors">Games</a></li>
              ...
              <li><a href="#" className="text-gray-400 hover:text-purple-400 transition-colors">Forums</a></li>
            </ul>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm flex items-center">
              Made with <Heart className="w-4 h-4 mx-1 text-red-500" /> by Game Portal Team
            </p>
