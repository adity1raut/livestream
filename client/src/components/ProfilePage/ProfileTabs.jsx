  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      {posts.map((post) => (
        <div
          key={post._id}
          className="aspect-square bg-gradient-to-br from-purple-100 to-pink-100 rounded-xl hover:shadow-lg transition-shadow cursor-pointer flex flex-col justify-between p-4"
        >
  ...
  return (
    <div className="py-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
      {following.map((f) => (
        ...
        >
          <img
            src={f.profile?.profileImage || "/default-avatar.png"}
            alt={f.username}
